...
static void SV_InitGameVM( qboolean restart ) {
	...
	// Hoyo: This section need to be moved up before VM_call. Before I found this bug, it was already fixed by Nathan Baggs, Kornik, and even fixed in later Q3 Arena.
