...
extern qboolean trap_PracticeRewind ( int targetTime ) ;
...
extern qboolean G_LoadPracticeState ( gentity_t * ent ) ;
extern qboolean G_SavePracticeState ( gentity_t * ent ) ;
...
extern qboolean G_Save_Decode ( byte * in , int insize , byte * out , int outsize ) ;
...
extern void Cmd_LoadState_f ( gentity_t * ent ) ;
extern void Cmd_SaveState_f ( gentity_t * ent ) ;
...
extern void G_SetWolfKickTimer ( int time ) ;
extern int G_GetWolfKickTimer ( void ) ;
...
extern void AICast_ResetFrameTiming ( int time ) ;
