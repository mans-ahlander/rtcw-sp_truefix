...
state("WolfSP")
{
    uint sr_magic              : "WolfSP.exe", 0x113CF0;
    uint sr_version            : "WolfSP.exe", 0x113CF4;
    uint sr_flags              : "WolfSP.exe", 0x113CF8;
    uint sr_mapSequence        : "WolfSP.exe", 0x113CFC;
    uint sr_transitionSequence : "WolfSP.exe", 0x113D00;
    string32 sr_mapName        : "WolfSP.exe", 0x113D04;
}
